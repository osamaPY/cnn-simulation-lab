      ...
      <div className="flex flex-col overflow-hidden rounded border border-border-muted bg-bg-panel">
        ...
        <div className="flex flex-col divide-y divide-border-subtle/50">
          {prediction.probabilities.map((probability, digit) => {
            ...
            return (
              <motion.div
                className={`grid grid-cols-12 items-center gap-2 p-1 sm:p-1.5 transition-colors duration-300 ${
              ...
              >
                <div className="col-span-2 flex justify-center">
                  <div
                    className={`flex h-5 w-5 items-center justify-center rounded-full text-[10px] font-bold font-display transition-all duration-300 ${
                      isWinner
                ...
                <div className="col-span-8 flex h-full items-center px-4">
                  <div className="relative h-1.5 w-full overflow-hidden rounded border border-border-subtle bg-black/40">
                    <motion.div
                ...
                <div
                  className={`col-span-2 text-right text-[10px] sm:text-xs font-semibold font-mono ${
        ...
        <div className="grid grid-cols-12 items-center gap-2 border-t border-border-muted bg-bg-deep/50 p-1.5 sm:p-2 text-[10px] sm:text-xs font-mono text-text-secondary">
