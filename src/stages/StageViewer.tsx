...
export function StageViewer() {
  ...
  const renderStage = () => {
    ...
    switch (currentStageId) {
      case 1:
        return <div className="flex flex-col items-center justify-center w-full h-full mx-auto"><PreprocessingPreview /></div>
      case 2:
  ...
  return (
    ...
    <div className={`absolute inset-0 flex flex-col items-center justify-center pointer-events-auto overflow-y-auto ${(currentStageId === 9 || currentStageId === 10) ? 'p-0' : 'p-3 sm:p-6'}`} id="stage-viewer">
