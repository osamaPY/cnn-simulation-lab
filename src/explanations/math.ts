...
export const mathExplanations: Record<number, ExplanationContent> = {
  ...
  6: {
    ...
    body: "The network has now found local patterns, but it does not need exact pixel-perfect positions for all of them. Max pooling compresses each 2 by 2 neighborhood into its strongest response, shrinking the spatial map while keeping the most important evidence. This makes the representation lighter, more robust, and less sensitive to tiny shifts in handwriting. In a sense, the network zooms out just enough to keep meaning while discarding redundancy.",
